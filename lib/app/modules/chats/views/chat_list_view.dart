...
import 'package:messaging_app/app/widgets/chat/app_bottom_nav.dart';
          ...
          children: [
                            ...
                            Positioned(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  // زائد حاف (بدون خلفية/شادو) — القائمة نفسها ستُرسم في الـOverlay خارج الهيدر
                                  InkWell(
                                    onTap: c.toggleMenu,
                                    borderRadius: BorderRadius.circular(20.r),
                                    child: SizedBox(
                ...
                Expanded(
                  child: Obx(() {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (_, i) {
                        final t = list[i];
                        return ChatCard(data: t, onTap: () => c.openThread(t));
                      },
                    );
                  }),
                ),
            ...
            Obx(() {
              if (!c.isMenuOpen.value || c.isSearching.value)
                return const SizedBox.shrink();
              return Positioned(
                // نفس تموضع القائمة التي كانت في الهيدر لكن الآن على مستوى الشاشة
                right: 16.w,
...
class _RightConcaveCornerClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(w, h);
    path.lineTo(0, h);
    path.cubicTo(w * 0.10, h * 0.75, w * 0.45, h * 0.35, w, 0);
    path.close();
    return path;
  }
